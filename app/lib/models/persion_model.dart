...
class SelfModel extends ChangeNotifier {

  // --------------BASE-------------------------------
  bool _switchTheme = false;   // theme true: dark, false: white
  bool get switchTheme => _switchTheme;
  

  switchThemeFunc()async{
    _switchTheme = !_switchTheme;
    (await SharedPreferences.getInstance()).setBool('theme', _switchTheme);
    notifyListeners();
  }
  ...
  Future<void> getProfile() async {
    ...
    _switchTheme = prefs.getBool('heme')??false;
